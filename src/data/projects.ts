    ...
    projects: [
      {
        ...
        link: "https://felicitas.pojtinger.com",
        repoLink:
    ...
    projects: [
      {
        ...
        date: "2019-07",
        description:
          "CLI to manage supra-cloud SSH keys, nodes, WireGuard (OSI Layer 3)/N2N (OSI Layer 2) overlay networks and Kubernetes clusters",
        icon: "server",
        color: "grey"
      },
      {
