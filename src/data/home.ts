...
const home = {
	head: {
		...
		googleSiteVerification:
			"8r_iYyrRDdrnEa65S44-1Wp6WfTlci6okFcPQEkjNAY",
	...
	content: {
		header: {
			...
			follow:
				"https://twitter.com/intent/user?screen_name=pojntfx",
		...
		links: [
			{
				...
				help: {
					title: "Curriculum Vitae",
					text:
						"A chronological list of all relevant events of my life.",
					docsLink:
			...
			},
			{
				...
				help: {
					title: "Abitur",
					text:
						"The results of my A-Level exams (in German).",
					docsLink:
			...
			},
			{
				...
				help: {
					title: "GitHub",
					text:
						"Mirrors of my libre software projects.",
			...
			},
			{
				...
				help: {
					title: "Instagram",
					text:
						"Quick and simple, multimedia-driven posts and stories by me.",
			...
			},
			{
				...
				help: {
					title: "GitLab",
					text:
						"Central place for all of my development work.",
			...
			},
			{
				...
				help: {
					title: "Reddit",
					text:
						"My account for general discussion.",
			...
			},
			{
				...
				help: {
					title: "NPM",
					text:
						"Most of my development works as NodeJS packages.",
		...
		skills: {
			description:
				"I'm a full stack developer based in Baiersbronn, Germany.",
			descriptionLink:
