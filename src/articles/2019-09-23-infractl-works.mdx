...
Options:
  ...
  -B, --backup-encryption-password [password]                                                                                 Backup's encryption password to access and restore backups (by default the backup system configuration won't be deployed)
...
- `-B`: The backup encryption password; keep this, if you loose it you won't be able to restore your backups.
